...
elif [[ x"${release}" == x"ubuntu" ]]; then#!/bin/bash#!/bin/bash#!/bin/bash
...
show_enable_status() {
    check_enabled
    if [[ $? == 0 ]]; then
        echo -e "Ya sea para comenzar : ${green}Es${plain}"
    else
        echo -e "Ya sea para comenzar : ${red}No${plain}"
    fi
}
...
echo -e "\033[1;32m[0]\033[1;31m|> \033[1;33mSalir de la secuencia de comandos"
...
echo -e "\033[1;32m[14]\033[1;31m|> \033[1;33mInstalación con un clic de bbr (el último kernel)"
...
echo -e "\033[1;32m[14]\033[1;31m|> \033[1;33mInstalación con un clic de bbr (el último kernel)\033[1;37m"
    ...
    echo -e "\033[1;37m" && read -p "Por favor ingrese la selección [0-14]: " num
